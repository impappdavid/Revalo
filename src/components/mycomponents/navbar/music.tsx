                    ...
                    <div className="max-h-96 h-full overflow-y-auto">
                        <div className="p-1.5 flex justify-between group items-center gap-4 bg-zinc-200/60 dark:bg-zinc-800 transition-all duration-200 cursor-pointer" onClick={() => setIsPlaying(!isPlaying)}>
                            ...
                            <div className="flex gap-4 items-center">
                                <Plus className="w-4 h-4 text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white" />
                                <div className="text-xs text-zinc-600 dark:text-zinc-400 pr-1.5">3:20</div>
                            </div>
                        </div>
                        ...
                        <div className="p-1.5 flex justify-between group items-center gap-4 transition-all duration-200 cursor-pointer" onClick={() => setIsPlaying(!isPlaying)}>
                            <div className="flex gap-2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="text-xs text-zinc-600 dark:text-zinc-400">Post Malone</div>
                                </div>
                            </div>
                            <div className="flex gap-4 items-center">
                                <Plus className="w-4 h-4 text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white" />
                                <div className="text-xs text-zinc-600 dark:text-zinc-400 pr-1.5">2:29</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-1.5 flex justify-between group items-center gap-4 transition-all duration-200 cursor-pointer" onClick={() => setIsPlaying(!isPlaying)}>
                        <div className="flex gap-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="text-xs text-zinc-600 dark:text-zinc-400">Lithe, Don Toliver</div>
                            </div>
                        </div>
                        <div className="flex gap-4 items-center">
                            <Plus className="w-4 h-4 text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white" />
                            <div className="text-xs text-zinc-600 dark:text-zinc-400 pr-1.5">2:03</div>
                        </div>
                    </div>
                    ...
                    <div className="p-1.5 flex justify-between group items-center gap-4 transition-all duration-200 cursor-pointer" onClick={() => setIsPlaying(!isPlaying)}>
                        <div className="flex gap-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="text-xs text-zinc-600 dark:text-zinc-400">Lil Tecca</div>
                            </div>
                        </div>
                        <div className="flex gap-4 items-center">
                            <Plus className="w-4 h-4 text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white" />
