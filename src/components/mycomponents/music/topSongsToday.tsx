        ...
        <>
            <div className="p-4 bg-zinc-900 border rounded-2xl flex flex-col gap-2">
                <div className="flex justify-between items-center">
                    ...
                    <Link to={"/"} className="text-sm text-blue-400 hover:underline">View Top 100</Link>
                </div>
                <div className="flex flex-col">
                    {songsData.map((song, index) => (
                        <div key={index} className="p-2 px-4 hover:bg-zinc-800 rounded-md cursor-pointer transition-all duration-200 grid grid-cols-6">
                            ...
                            <div className="text-sm col-span-2 flex items-center text-zinc-400">{song.collection}</div>
                            <div className="flex justify-end text-sm items-center text-zinc-400">{song.time}</div>
                        </div>
                    ))}
