...
function Menu() {
    ...
    return (
        <>
            <div className="bg-zinc-900 rounded-2xl border p-2 flex flex-col gap-2">
                <div className="flex justify-between p-1 w-full border-b">
                    <div className="w-24 flex gap-2 items-center border-r pr-2 group cursor-pointer">
                ...
                <div className="flex flex-wrap gap-4 p-2">
                    <div className="flex flex-col gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Fashion</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Home</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Beauty</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">For Kids</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Electronics</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Sports</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Repair</div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Hobbies</div>
                    </div>
                    <div className="flex flex-col items-center gap-1 cursor-pointer hover:opacity-80 transition-all duration-200">
                        ...
                        <div className="text-xs text-center text-zinc-300">Vehicles</div>
                    </div>
                </div>
            </div>
        </>
