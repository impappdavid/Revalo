                    ...
                    <DialogContent className="sm:max-w-3xl max-w-lg">
                        <div className="relative">
                            <div className="grid grid-cols-2  gap-2 h-[650px]">
                                <div className="p-2 bg-zinc-800/50 rounded-2xl flex flex-col justify-center items-center">
                                    <label className="group flex h-full w-full cursor-pointer flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed bg-zinc-900/20 hover:bg-zinc-800/20 px-6 text-center transition-colors ">
                                        <div className="grid place-items-center rounded-md border-2 border-dashed border-zinc-300 p-4 transition-colors ">
                                            <svg className="h-6 w-6 text-zinc-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                        ...
                                        <p className="text-sm text-zinc-300 font-medium">Drag and drop photo or video here</p>
                                        ...
                                        <span className="text-sm text-zinc-300 py-1.5 px-3 hover:bg-zinc-900/80 rounded-lg font-medium transition-all duration-200">Select background</span>
                                ...
                                <div className="flex flex-col justify-between w-full h-full ">
                                    <div className="flex flex-col">
                                        <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                            <CaseSensitive className="w-5.5 h-5.5 text-zinc-400" />
                                            <div className="text-zinc-100 text-sm">Text</div>
                                        </div>
                                        <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 28 28" className="fill-zinc-400">
                                            ...
                                            <div className="text-zinc-100 text-sm">Stickers</div>
                                        </div>
                                        <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" className="fill-zinc-400">
                                            ...
                                            <div className="text-zinc-100 text-sm">Paintbrush</div>
                                        </div>
                                        <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" className="stroke-zinc-400">
                                            ...
                                            <div className="text-zinc-100 text-sm">Background</div>
                                        </div>
                                        <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 48 48">
                                                <defs>
                                                    <mask id="SVGRa3Mgdns">
                                                        <g fill="none" className="stroke-zinc-400" stroke-linejoin="round" stroke-width="4">
                                                            ...
                                                            <path className="fill-zinc-400" d="M24 28c6.627 0 12-5.373 12-12S30.627 4 24 4S12 9.373 12 16s5.373 12 12 12Z" />
                                                        </g>
                                                    </mask>
                                                </defs>
                                                <path className="fill-zinc-400" d="M0 0h48v48H0z" mask="url(#SVGRa3Mgdns)" />
                                            </svg>
                                            <div className="text-zinc-100 text-sm">Filters</div>
                                        </div>
                                        <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                            <Settings2 className="w-4.5 h-4.5 text-zinc-400" />
                                            <div className="text-zinc-100 text-sm">Color correction</div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <div className="flex flex-col">
                                            <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                                <LockOpen className="w-4.5 h-4.5 text-zinc-400" />
                                                <div className="text-zinc-100 text-sm">Everyone</div>
                                            </div>
                                            <div className="flex gap-2 items-center hover:bg-zinc-800/50 px-3 py-2 rounded-lg cursor-pointer transition-all duration-200">
                                                <Ellipsis className="w-4.5 h-4.5 text-zinc-400" />
                                                <div className="text-zinc-100 text-sm">More</div>
                                            </div>
                                        </div>
