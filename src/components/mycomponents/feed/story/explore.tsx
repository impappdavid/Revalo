                    ...
                    <div className="relative flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-3 gap-2 h-[650px]">
                            <div className="relative overflow-hidden cursor-pointer hover:opacity-80 transition-all duration-200 h-fit">
                                ...
                                <img src="/images/holiday.jpg" alt="" className="w-full h-64" />
                            </div>
                            ...
                            <div className="relative overflow-hidden cursor-pointer hover:opacity-80 transition-all duration-200 h-fit">
                                ...
                                <img src="/images/food.jpg" alt="" className="w-full h-64" />
                            </div>
                            ...
                            <div className="relative overflow-hidden cursor-pointer hover:opacity-80 transition-all duration-200 h-fit">
                                ...
                                <img src="/images/restaurant.jpg" alt="" className="w-full h-64" />
                            </div>
