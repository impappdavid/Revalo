...
const clips = [
    { id: 1, type: "video", src: "/test.mp4", likes: 1356, comments: 12, views: "10k", username: "Revalo", tags: ["foryou", "motivational", "lockin"] },
    { id: 2, type: "image", src: "/logo.png", likes: 13200, comments: 45, views: "124k", username: "Revalo", tags: ["foryou", "socialmedia", "clips"] },
];
    ...
    return (
        ...
        >
                    ...
                    {clip.type === "video" ? (
                        <div className="relative w-full h-full">
                            ...
                            <button
                                ...
                                className={`absolute inset-0 flex items-center justify-center text-white bg-opacity-100 hover:bg-opacity-40 transition-opacity ${isPlaying ? "bg-transparent" : "bg-black/20"
                                    }`}
                            >
                                {isPlaying && current === i ? (
                                    <div></div>
            ...
            <div className="absolute bottom-24 right-4 flex flex-col gap-3 text-zinc-300">
                ...
                <div className="flex flex-col items-center group cursor-pointer">
                    <div className="p-2 group-hover:bg-zinc-500/20 rounded-full transition-all duration-200 fill-zinc-300 group-hover:fill-emerald-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className="w-7 h-7">
